...
public class L1Cooking {
	...
	public static void useCookingItem(L1PcInstance pc, L1ItemInstance item) {
		...
		if (itemId == 41284 || itemId == 41292
				...
				|| itemId == 49251 || itemId == 49259) { // fU[g
			if (pc.get_food() != 225) {
		...
		if (itemId >= 41277 && itemId <= 41283 // Lv1¿
				|| itemId >= 41285 && itemId <= 41291 // Lv1¶zÌ¿
				|| itemId >= 49049 && itemId <= 49055 // Lv2¿
				|| itemId >= 49057 && itemId <= 49063 // Lv2¶zÌ¿
				|| itemId >= 49244 && itemId <= 49250 // Lv3¿
				|| itemId >= 49252 && itemId <= 49258) { // Lv3¶zÌ¿
		...
		if (itemId == 41277 || itemId == 41285) { 
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49049 || itemId == 49057) { // LrAJiby
			if (itemId == 49049) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49050 || itemId == 49058) { // AQ[^[Xe[L
			if (itemId == 49050) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49051 || itemId == 49059) { // ^[ghSÌÙq
			if (itemId == 49051) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49052 || itemId == 49060) { // LEBpbgÄ«
			if (itemId == 49052) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49053 || itemId == 49061) { // XR[sIÄ«
			if (itemId == 49053) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49054 || itemId == 49062) { // CbJhV`[
			if (itemId == 49054) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49055 || itemId == 49063) { // NrÌøÄ«
			if (itemId == 49055) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49056 || itemId == 49064) { // NuX[v
			if (itemId == 49056) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49244 || itemId == 49252) { // NX^VAÌnT~Ä«
			if (itemId == 49244) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49245 || itemId == 49253) { // OtHÄ«
			if (itemId == 49245) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49246 || itemId == 49254) { // RJgXXe[L
			if (itemId == 49246) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49247 || itemId == 49255) { // ^[ghSÄ«
			if (itemId == 49247) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49248 || itemId == 49256) { // bT[hSÌèHæ
			if (itemId == 49248) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49249 || itemId == 49257) { // hCNÄ«
			if (itemId == 49249) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49250 || itemId == 49258) { // [CÌV`[
			if (itemId == 49250) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49251 || itemId == 49259) { // oVXNÌX[v
			if (itemId == 49251) {
